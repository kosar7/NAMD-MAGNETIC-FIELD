...
//fepe
  ...
  Bool fixCellDimZ;
	...
	Bool mFieldOn;                  //  Should a magnetic field be applied
	Bool mFieldNormalized;          //  Is mField vector scaled by cell basis vectors
	zVector mField;                 //  Magnetic field vector to be applied
	BigReal mFieldFreq;		// Frequency of the magnetic field
	BigReal mFieldPhase;		// Phase phi, cos(w*t-phi*PI/180) 
